...
<div class="container" style="margin-top: 20px">
	<div class="col-md-12">
    <h2 style="text-align: center;margin-bottom: 30px"> Add User</h2><hr>
    <form method="post" action="<?php echo site_url('auth/insertUser'); ?>" enctype="multipart/form-data">
        <right><p>
        <a  style="padding: 10px 20px;">NIM</a>
        </p></right>
        <center><input type="text"  class="form-control"name="NIM" size="30" style="width: 98%; "></center><br>
        <right><p>
        <a  style="padding: 10px 20px;">NAMA</a>
        </p></right>
        <center><input type="text"  class="form-control"name="NAMA" size="30" style="width: 98%; "></center><br>
        <right><p>
        <a  style="padding: 10px 20px;">USERNAME</a>
        </p></right>
        <center><input type="text"  class="form-control"name="USERNAME" size="30" style="width: 98%; "></center><br>
        <right><p>
        <a  style="padding: 10px 20px;">ALAMAT</a>
        </p></right>
        <center><input type="text"  class="form-control"name="ALAMAT" size="30" style="width: 98%; "></center><br>
        <right><p>
        <a  style="padding: 10px 20px;">PASSWORD</a>
        </p></right>
        <center><input type="text"  class="form-control"name="PASSWORD" size="30" style="width: 98%; "></center><br>
        <right><p>
        <a  style="padding: 10px 20px;">FOTO</a>
        </p></right>
        <center><input type="file"  class="form-control"name="foto" size="30" style="width: 98%; "></center><hr>
        <center><button class="btn btn-block mybtn btn-yellow tx-tfm"" type="submit">Submit</button></center>
        <br>
    </form>
    <form action="<?php echo site_url('auth/toList'); ?>" method="POST" class="form-inline my-2 my-lg-0">
